...
% PLACE
demo_online('OKH','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain',100000,'updateInterval',100,'trigger','fix','reservoirSize',200,'override',1)

demo_online('SketchHash','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain',100000,'updateInterval',100,'trigger','fix','reservoirSize',200,'override',1)

demo_online('AdaptHash','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain', 100000,'updateInterval',100,'trigger','fix','reservoirSize',200,'override',1)

demo_online('OSH','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain', 100000,'updateInterval',100,'trigger','fix','reservoirSize',200,'override',1)
	
demo_online('MIHash','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain',100000,'updateInterval',100,'trigger','mi','reservoirSize',5000,'override',1)

demo_online('HCOH','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain', 100000,'updateInterval',100,'trigger','fix','reservoirSize',200,'override',1)

demo_online('SDOH','place',64,'unseen',1,'ntrials',1,'ntest',2,'numTrain', 100000,'updateInterval',2000,'trigger','fix','reservoirSize',200,'override',1)
