...
% CIFAR10
demo_online('OKH','cifar',32,'ntrials',1,'ntest',2,'numTrain',2000,'updateInterval',100,'trigger','fix','override',1)

demo_online('SketchHash','cifar',32,'ntrials',1,'ntest',2,'numTrain',2000,'updateInterval',100,'trigger','fix','override',1)

demo_online('AdaptHash','cifar',32,'ntrials',1,'ntest',2,'numTrain', 2000,'updateInterval',100,'trigger','fix','override',1)
